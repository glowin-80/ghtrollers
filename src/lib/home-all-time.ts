...
export function buildAllTimeHighlights(catches: Catch[], members: Member[]): AllTimeHighlight[] {
  ...
  if (bigFiveLeader) {
    highlights.push({
      filter: "bigfive",
      identityKey: bigFiveLeader.breakdown.identityKey,
      title: "Big Five",
  ...
  if (largestPerch) {
    highlights.push({
      filter: "abborre",
      identityKey: getCatchOwnerIdentityKey(largestPerch),
      title: "Abborre",
      winnerName: getCatchOwnerDisplayName(largestPerch, members),
  ...
  if (largestPike) {
    highlights.push({
      filter: "gädda",
      identityKey: getCatchOwnerIdentityKey(largestPike),
      title: "Gädda",
      winnerName: getCatchOwnerDisplayName(largestPike, members),
  ...
  if (largestFineFish) {
    highlights.push({
      filter: "fina",
      identityKey: getCatchOwnerIdentityKey(largestFineFish),
      title: "Fina fisken",
      winnerName: getCatchOwnerDisplayName(largestFineFish, members),
