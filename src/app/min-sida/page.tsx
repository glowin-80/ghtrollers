...
export default function MinSidaPage() {
  ...
  const [showLiveScope, setShowLiveScope] = useState(false);
  ...
  const visibleCatches = useMemo(() => catches.filter((item) => (showLiveScope || !item.live_scope) && (showAbroad || !item.caught_abroad)), [catches, showAbroad, showLiveScope]);
